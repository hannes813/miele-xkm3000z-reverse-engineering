...
![Reverse Engineering Setup](docs/images/Miele_OSGi_Runtime_2016.png)
...
![Zigbee Traffic](docs/images/Zigbee_Rohdaten.jpg)
...
docker run --rm -it --network host \
  ...
  -e MIELE_ZNP_HOST='192.xxx.xx.xxx' \
  -e MIELE_ZNP_PORT='xxxx' \
  -e MIELE_TARGET_NWK=0x537D \
  -e MQTT_HOST='192.xxx.xx.xxx' \
